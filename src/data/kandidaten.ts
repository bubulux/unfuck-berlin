...
export const KANDIDATEN: Kandidat[] = [
  { name: 'Anna Auerbach', slug: 'anna-auerbach', listenplatz: 1, bezirk: 'Mitte', image: '/pics/kandis/anna-auerbach.jpg' },
  { name: 'Paul Loeper', slug: 'paul-loeper', listenplatz: 2, bezirk: 'Pankow', image: '/pics/kandis/paul-loeper.png' },
  { name: 'Rafael Kaaz', slug: 'rafael-kaaz', listenplatz: 3, bezirk: 'Charlottenburg-Wilmersdorf', image: '/pics/kandis/rafael-kaaz.jpg' },
  ...
  { name: 'Rahel Demant', slug: 'rahel-demant', listenplatz: 14, bezirk: 'Tempelhof-Schöneberg', image: '/pics/kandis/rahel-demant.jpg' },
