...
export const PAGES_CMS = [
  ...
  },
  {
    ...
    "body": "Unsere Kandidierenden stehen für frische Ideen, lösungsorientierte Politik und den Mut, neue Wege zu gehen. Sie kommen aus unterschiedlichen Lebensbereichen, teilen aber ein gemeinsames Ziel: Berlin nachhaltig, gerecht und zukunftsfähig zu gestalten.\n\nLerne unser Team kennen und erfahre, welche Themen ihnen besonders am Herzen liegen. Gemeinsam mit dir arbeiten wir an einem Berlin, dass für alle funktioniert.",
    "content_modules": [
      {
        "_key": "f2e5a09d818a",
        "_type": "hero_linear",
