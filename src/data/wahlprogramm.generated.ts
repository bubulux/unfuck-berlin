...
// Letzter Abruf: 2026-07-21T19:29:46.500Z
...
export const WAHLPROGRAMM_CMS = {
  ...
  "pillars": [
    ...
    {
      "title": "Berlin schützt",
      "tags": [
        "Sicherheit",
        "Gesundheit",
        "Zusammenhalt"
      ],
      "body": "…verbindet wirksame Prävention, entschlossene Strafverfolgung und verlässlichen Opferschutz mit wohnortnahen Gesundheitszentren im Kiez und einer Stadt, die krisenfest wird."
    },
    {
      "title": "Berlin gewinnt",
      "tags": [
        "Zukunft",
        "Resilienz",
        "Natur"
      ],
      "body": "…begreift Klimaschutz als Investition statt Verzichtsagenda: mit einer Solaroffensive, klimaneutraler Fernwärme durch Großwärmepumpen und der Schwammstadt gegen Hitze und Starkregen."
    },
    {
      "title": "Berlin verbindet",
      "tags": [
        "Menschen",
        "Europa",
        "die Welt"
      ],
      "body": "…macht Europa im Alltag erlebbar: mit Integration als Standortvorteil, Englisch als zweiter Servicesprache der Verwaltung und einer Kulturpolitik, die Clubs und freie Szene verlässlich absichert."
    }
  ],
  "europa": {
    "heading": [
